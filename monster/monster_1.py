...
import time
import random
from global_stuff.boundaries_for_animation import BOUNDRY_RIGHT, BOUNDRY_LEFT, BOUNDRY_BOTTOM, BOUNDRY_TOP
...
class Monster1(pg.sprite.Sprite):
    ...
    def move_monster(self):
        ...
        if self.direction == -2:
            ...
            if self.monster_rect.bottom < BOUNDRY_TOP:
                self.monster_rect.top = BOUNDRY_TOP
                self.direction = 2
        ...
        if self.direction == 2:
            ...
            if self.monster_rect.bottom > BOUNDRY_BOTTOM:
                self.monster_rect.bottom  =  BOUNDRY_BOTTOM
                self.direction = -2
